...
public class SkuAttrValueController {
    ...
    public Result page(@ApiIgnore @RequestParam Map<String, Object> params){
        PageData<SkuAttrValueDto> page = skuAttrValueService.page(params);
    ...
    public Result get(@PathVariable("id") Long id){
        SkuAttrValueDto data = skuAttrValueService.get(id);
        return new Result().ok(data);
    }

    @PostMapping
    @ApiOperation("save")
    public Result save(@RequestBody SkuAttrValueDto dto){
        skuAttrValueService.save(dto);
        return new Result();
    }

    @PutMapping
    @ApiOperation("update")
    public Result update(@RequestBody SkuAttrValueDto dto){
        skuAttrValueService.update(dto);
        return new Result();
    }
    ...
    public Result delete(@RequestBody Long[] ids){
        skuAttrValueService.delete(ids);
        return new Result();
    }
}