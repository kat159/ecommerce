...
@RestController
@RequestMapping("product/productcomment")
...
public class ProductCommentController {
    ...
    public Result page(@ApiIgnore @RequestParam Map<String, Object> params){
        PageData<ProductCommentDto> page = productCommentService.page(params);
    ...
    public Result get(@PathVariable("id") Long id){
        ProductCommentDto data = productCommentService.get(id);
        return new Result().ok(data);
    }

    @PostMapping
    @ApiOperation("save")
    public Result save(@RequestBody ProductCommentDto dto){
        productCommentService.save(dto);
        return new Result();
    }

    @PutMapping
    @ApiOperation("update")
    public Result update(@RequestBody ProductCommentDto dto){
        productCommentService.update(dto);
        return new Result();
    }
