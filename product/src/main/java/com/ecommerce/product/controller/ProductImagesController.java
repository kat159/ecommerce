...
@RestController
@RequestMapping("product/productimages")
...
public class ProductImagesController {
    ...
    public Result page(@ApiIgnore @RequestParam Map<String, Object> params){
        PageData<ProductImagesDto> page = productImagesService.page(params);
    ...
    public Result get(@PathVariable("id") Long id){
        ProductImagesDto data = productImagesService.get(id);
        return new Result().ok(data);
    }

    @PostMapping
    @ApiOperation("save")
    public Result save(@RequestBody ProductImagesDto dto){
        productImagesService.save(dto);
        return new Result();
    }

    @PutMapping
    @ApiOperation("update")
    public Result update(@RequestBody ProductImagesDto dto){
        productImagesService.update(dto);
        return new Result();
    }
    ...
    public Result delete(@RequestBody Long[] ids){
        productImagesService.delete(ids);
        return new Result();
    }
}