...
@RestController
@RequestMapping("warehouse/ordertask")
@Api(tags="order task")
public class OrderTaskController {
    ...
    public Result page(@ApiIgnore @RequestParam Map<String, Object> params){
        PageData<OrderTaskDto> page = orderTaskService.page(params);
    ...
    public Result get(@PathVariable("id") Long id){
        OrderTaskDto data = orderTaskService.get(id);
    ...
    @PutMapping
    @ApiOperation("update")
    public Result update(@RequestBody OrderTaskDto dto){
