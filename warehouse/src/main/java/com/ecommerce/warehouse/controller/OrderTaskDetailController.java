...
@RestController
@RequestMapping("warehouse/ordertaskdetail")
@Api(tags="order task detail")
public class OrderTaskDetailController {
    ...
    public Result page(@ApiIgnore @RequestParam Map<String, Object> params){
        PageData<OrderTaskDetailDto> page = orderTaskDetailService.page(params);
    ...
    public Result get(@PathVariable("id") Long id){
        OrderTaskDetailDto data = orderTaskDetailService.get(id);
        return new Result().ok(data);
    }

    @PostMapping
    @ApiOperation("save")
    public Result save(@RequestBody OrderTaskDetailDto dto){
        orderTaskDetailService.save(dto);
        return new Result();
    }

    @PutMapping
    @ApiOperation("update")
    public Result update(@RequestBody OrderTaskDetailDto dto){
        orderTaskDetailService.update(dto);
        return new Result();
    }
    ...
    public Result delete(@RequestBody Long[] ids){
        orderTaskDetailService.delete(ids);
        return new Result();
    }
}