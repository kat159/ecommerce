...
public class LoginRecordController {
    ...
    public Result page(@ApiIgnore @RequestParam Map<String, Object> params){
        PageData<LoginRecordDto> page = loginRecordService.page(params);
    ...
    public Result get(@PathVariable("id") Long id){
        LoginRecordDto data = loginRecordService.get(id);
        return new Result().ok(data);
    }

    @PostMapping
    @ApiOperation("save")
    public Result save(@RequestBody LoginRecordDto dto){
        loginRecordService.save(dto);
        return new Result();
    }

    @PutMapping
    @ApiOperation("update")
    public Result update(@RequestBody LoginRecordDto dto){
        loginRecordService.update(dto);
        return new Result();
    }
