...
@RestController
@RequestMapping("member/membershippoint")
@Api(tags="membership history, many to one member")
public class MembershipPointController {
    ...
    public Result page(@ApiIgnore @RequestParam Map<String, Object> params){
        PageData<MembershipPointDto> page = membershipPointService.page(params);
    ...
    public Result get(@PathVariable("id") Long id){
        MembershipPointDto data = membershipPointService.get(id);
        return new Result().ok(data);
    }

    @PostMapping
    @ApiOperation("save")
    public Result save(@RequestBody MembershipPointDto dto){
        membershipPointService.save(dto);
        return new Result();
    }

    @PutMapping
    @ApiOperation("update")
    public Result update(@RequestBody MembershipPointDto dto){
        membershipPointService.update(dto);
        return new Result();
    }
    ...
    public Result delete(@RequestBody Long[] ids){
        membershipPointService.delete(ids);
        return new Result();
    }
}