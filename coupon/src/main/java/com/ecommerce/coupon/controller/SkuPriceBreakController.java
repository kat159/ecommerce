...
@RestController
@RequestMapping("coupon/skupricebreak")
@Api(tags="SKU full reduction information")
public class SkuPriceBreakController {
    @Autowired
    private SkuPriceBreakService skuPriceBreakService;
    ...
    public Result page(@ApiIgnore @RequestParam Map<String, Object> params){
        PageData<SkuPriceBreakDto> page = skuPriceBreakService.page(params);
    ...
    public Result get(@PathVariable("id") Long id){
        SkuPriceBreakDto data = skuPriceBreakService.get(id);
        return new Result().ok(data);
    }

    @PostMapping
    @ApiOperation("save")
    public Result save(@RequestBody SkuPriceBreakDto dto){
        skuPriceBreakService.save(dto);
        return new Result();
    }

    @PutMapping
    @ApiOperation("update")
    public Result update(@RequestBody SkuPriceBreakDto dto){
        skuPriceBreakService.update(dto);
        return new Result();
    }
    ...
    public Result delete(@RequestBody Long[] ids){
        skuPriceBreakService.delete(ids);
        return new Result();
    }
}