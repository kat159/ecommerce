...
@RestController
@RequestMapping("coupon/promotionalskunotice")
@Api(tags="Promotional Sku Notification Subscription")
public class PromotionalSkuNoticeController {
    @Autowired
    private PromotionalSkuNoticeService promotionalSkuNoticeService;
    ...
    public Result page(@ApiIgnore @RequestParam Map<String, Object> params){
        PageData<PromotionalSkuNoticeDto> page = promotionalSkuNoticeService.page(params);
    ...
    public Result get(@PathVariable("id") Long id){
        PromotionalSkuNoticeDto data = promotionalSkuNoticeService.get(id);
        return new Result().ok(data);
    }

    @PostMapping
    @ApiOperation("save")
    public Result save(@RequestBody PromotionalSkuNoticeDto dto){
        promotionalSkuNoticeService.save(dto);
        return new Result();
    }

    @PutMapping
    @ApiOperation("update")
    public Result update(@RequestBody PromotionalSkuNoticeDto dto){
        promotionalSkuNoticeService.update(dto);
        return new Result();
    }
    ...
    public Result delete(@RequestBody Long[] ids){
        promotionalSkuNoticeService.delete(ids);
        return new Result();
    }
}