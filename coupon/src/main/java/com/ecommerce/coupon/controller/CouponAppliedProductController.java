...
@RestController
@RequestMapping("coupon/couponappliedproduct")
@Api(tags="Products avaiable to use corresponding coupon")
public class CouponAppliedProductController {
    @Autowired
    private CouponAppliedProductService couponAppliedProductService;
    ...
    public Result page(@ApiIgnore @RequestParam Map<String, Object> params){
        PageData<CouponAppliedProductDto> page = couponAppliedProductService.page(params);
    ...
    public Result get(@PathVariable("id") Long id){
        CouponAppliedProductDto data = couponAppliedProductService.get(id);
        return new Result().ok(data);
    }

    @PostMapping
    @ApiOperation("save")
    public Result save(@RequestBody CouponAppliedProductDto dto){
        couponAppliedProductService.save(dto);
        return new Result();
    }

    @PutMapping
    @ApiOperation("update")
    public Result update(@RequestBody CouponAppliedProductDto dto){
        couponAppliedProductService.update(dto);
        return new Result();
    }
    ...
    public Result delete(@RequestBody Long[] ids){
        couponAppliedProductService.delete(ids);
        return new Result();
    }
}