...
@RestController
@RequestMapping("coupon/promotionsession")
@Api(tags="Promotion Session")
public class PromotionSessionController {
    @Autowired
    private PromotionSessionService promotionSessionService;
    ...
    public Result page(@ApiIgnore @RequestParam Map<String, Object> params){
        PageData<PromotionSessionDto> page = promotionSessionService.page(params);
    ...
    public Result get(@PathVariable("id") Long id){
        PromotionSessionDto data = promotionSessionService.get(id);
        return new Result().ok(data);
    }

    @PostMapping
    @ApiOperation("save")
    public Result save(@RequestBody PromotionSessionDto dto){
        promotionSessionService.save(dto);
        return new Result();
    }

    @PutMapping
    @ApiOperation("update")
    public Result update(@RequestBody PromotionSessionDto dto){
        promotionSessionService.update(dto);
        return new Result();
    }
    ...
    public Result delete(@RequestBody Long[] ids){
        promotionSessionService.delete(ids);
        return new Result();
    }
}