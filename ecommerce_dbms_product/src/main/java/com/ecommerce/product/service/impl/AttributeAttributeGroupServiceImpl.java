...
@Service
public class AttributeAttributeGroupServiceImpl
        extends CrudServiceImpl<AttributeAttributeGroupDao, AttributeAttributeGroupEntity, AttributeAttributeGroupDto>
        implements AttributeAttributeGroupService {
