...
@RestController
@RequestMapping("coupon/homepagesubject")
@Api(tags="Homepage Subjects [There will be many subjects on the homepage, each subject links to a new page, displaying subject product information]")
public class HomepageSubjectController {
    @Autowired
    private HomepageSubjectService homepageSubjectService;
    ...
    public Result page(@ApiIgnore @RequestParam Map<String, Object> params){
        PageData<HomepageSubjectDto> page = homepageSubjectService.page(params);
    ...
    public Result get(@PathVariable("id") Long id){
        HomepageSubjectDto data = homepageSubjectService.get(id);
        return new Result().ok(data);
    }

    @PostMapping
    @ApiOperation("save")
    public Result save(@RequestBody HomepageSubjectDto dto){
        homepageSubjectService.save(dto);
        return new Result();
    }

    @PutMapping
    @ApiOperation("update")
    public Result update(@RequestBody HomepageSubjectDto dto){
        homepageSubjectService.update(dto);
        return new Result();
    }
    ...
    public Result delete(@RequestBody Long[] ids){
        homepageSubjectService.delete(ids);
        return new Result();
    }
}