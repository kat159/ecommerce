...
@RestController
@RequestMapping("coupon/promotionsku")
@Api(tags="Promotion-Sku join table")
public class PromotionSkuController {
    ...
    public Result page(@ApiIgnore @RequestParam Map<String, Object> params){
        PageData<PromotionSkuDto> page = promotionSkuService.page(params);
    ...
    public Result get(@PathVariable("id") Long id){
        PromotionSkuDto data = promotionSkuService.get(id);
        return new Result().ok(data);
    }

    @PostMapping
    @ApiOperation("save")
    public Result save(@RequestBody PromotionSkuDto dto){
        promotionSkuService.save(dto);
        return new Result();
    }

    @PutMapping
    @ApiOperation("update")
    public Result update(@RequestBody PromotionSkuDto dto){
        promotionSkuService.update(dto);
        return new Result();
    }
    ...
    public Result delete(@RequestBody Long[] ids){
        promotionSkuService.delete(ids);
        return new Result();
    }
}