...
@RestController
@RequestMapping("warehouse/skuinventory")
@Api(tags="sku_inventory")
public class SkuInventoryController {
    ...
    public Result page(@ApiIgnore @RequestParam Map<String, Object> params){
        PageData<SkuInventoryDto> page = skuInventoryService.page(params);
    ...
    public Result get(@PathVariable("id") Long id){
        SkuInventoryDto data = skuInventoryService.get(id);
        return new Result().ok(data);
    }

    @PostMapping
    @ApiOperation("save")
    public Result save(@RequestBody SkuInventoryDto dto){
        skuInventoryService.save(dto);
        return new Result();
    }

    @PutMapping
    @ApiOperation("update")
    public Result update(@RequestBody SkuInventoryDto dto){
        skuInventoryService.update(dto);
        return new Result();
    }
    ...
    public Result delete(@RequestBody Long[] ids){
        skuInventoryService.delete(ids);
        return new Result();
    }
}